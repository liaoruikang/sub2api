	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldLimitedTimeMultiplierEnabled,
				group.FieldLimitedTimeMultiplierCron,
				group.FieldLimitedTimeMultiplierDurationMinutes,
				group.FieldLimitedTimeMultiplierValue,
				...
				group.FieldRpmLimit,
				group.FieldLimitedTimeRpmLimit,
				group.FieldLimitedTimeUserConcurrencyLimit,
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		LimitedTimeMultiplierEnabled:         g.LimitedTimeMultiplierEnabled,
		LimitedTimeMultiplierCron:            g.LimitedTimeMultiplierCron,
		LimitedTimeMultiplierDurationMinutes: g.LimitedTimeMultiplierDurationMinutes,
		LimitedTimeMultiplierValue:           g.LimitedTimeMultiplierValue,
		...
		RPMLimit:                             g.RpmLimit,
		LimitedTimeRPMLimit:                  g.LimitedTimeRpmLimit,
		LimitedTimeUserConcurrencyLimit:      g.LimitedTimeUserConcurrencyLimit,
