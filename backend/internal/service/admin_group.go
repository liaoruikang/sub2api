...
func (s *adminServiceImpl) UpdateGroup(ctx context.Context, id int64, input *UpdateGroupInput) (*Group, error) {
	...
	limitedTimeMultiplierTouched := input.SubscriptionType != "" ||
		input.LimitedTimeMultiplierEnabled != nil ||
		input.LimitedTimeMultiplierCron != nil ||
		input.LimitedTimeMultiplierDurationMinutes != nil ||
		input.LimitedTimeMultiplierValue != nil
	...
	} else if limitedTimeMultiplierTouched {
		group.LimitedTimeMultiplierCron = strings.TrimSpace(group.LimitedTimeMultiplierCron)
		group.LimitedTimeMultiplierValue = normalizeLimitedTimeMultiplierValue(group.LimitedTimeMultiplierValue)
