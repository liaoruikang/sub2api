...
const (
	...
	AffiliateWithdrawalEnabledDefault   = false
	AffiliateWithdrawalMinAmountDefault = 10.0
	AffiliateWithdrawalFeeRateDefault   = 0.0
	AffiliateWithdrawalFeeRateMin       = 0.0
	AffiliateWithdrawalFeeRateMax       = 100.0
...
const (
	...
	SettingKeyAffiliateWithdrawalEnabled          = "affiliate_withdrawal_enabled"     // 是否允许用户申请支付宝提现
	SettingKeyAffiliateWithdrawalMinAmount        = "affiliate_withdrawal_min_amount"  // 最低提现总额
	SettingKeyAffiliateWithdrawalFeeRate          = "affiliate_withdrawal_fee_rate"    // 提现手续费率（百分比）
	...
	// 最高调度轮转设置（JSON：HighestSchedulingRotationConfig）
	SettingKeyHighestSchedulingRotationConfig = "highest_scheduling_rotation_config"
	...
	// SettingKeyImagePlaygroundEnabled and SettingKeyVideoJobsEnabled are opt-out feature
	// switches for the user-facing image playground and video jobs entries.
	SettingKeyImagePlaygroundEnabled = "image_playground_enabled"
	SettingKeyVideoJobsEnabled       = "video_jobs_enabled"
