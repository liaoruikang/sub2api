...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			user.GET("/aff/withdrawal-accounts", h.User.ListAffiliateWithdrawalAccounts)
			user.POST("/aff/withdrawal-accounts", h.User.CreateAffiliateWithdrawalAccount)
			user.PUT("/aff/withdrawal-accounts/:id", h.User.UpdateAffiliateWithdrawalAccount)
			user.PUT("/aff/withdrawal-accounts/:id/default", h.User.SetDefaultAffiliateWithdrawalAccount)
			user.DELETE("/aff/withdrawal-accounts/:id", h.User.DeleteAffiliateWithdrawalAccount)
