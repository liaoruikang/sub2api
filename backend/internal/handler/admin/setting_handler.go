...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		AffiliateWithdrawalEnabled:                             settings.AffiliateWithdrawalEnabled,
		AffiliateWithdrawalMinAmount:                           settings.AffiliateWithdrawalMinAmount,
		AffiliateWithdrawalFeeRate:                             settings.AffiliateWithdrawalFeeRate,
		...
		VideoJobsEnabled:         settings.VideoJobsEnabled,
