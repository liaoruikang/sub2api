...
func (s *stubAdminService) ClearGroupLimitedTimeRPMOverrides(_ context.Context, _ int64) error {
	return nil
}

func (s *stubAdminService) BatchSetGroupLimitedTimeRPMOverrides(_ context.Context, _ int64, _ []service.GroupLimitedTimeRPMOverrideInput) error {
	return nil
}
