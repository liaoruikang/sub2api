...
type UpdateSettingsRequest struct {
	...
	// Image playground / video jobs feature switches
	ImagePlaygroundEnabled *bool `json:"image_playground_enabled"`
	VideoJobsEnabled       *bool `json:"video_jobs_enabled"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		VideoJobsEnabled: func() bool {
			if req.VideoJobsEnabled != nil {
				return *req.VideoJobsEnabled
			}
			return previousSettings.VideoJobsEnabled
		}(),
	...
	payload := dto.SystemSettings{
		...
		VideoJobsEnabled:         updatedSettings.VideoJobsEnabled,
