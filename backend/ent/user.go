...
type UserEdges struct {
	...
	// AnnouncementGroupPriceReads holds the value of the announcement_group_price_reads edge.
	AnnouncementGroupPriceReads []*AnnouncementGroupPriceRead `json:"announcement_group_price_reads,omitempty"`
...
// AnnouncementGroupPriceReadsOrErr returns the AnnouncementGroupPriceReads value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) AnnouncementGroupPriceReadsOrErr() ([]*AnnouncementGroupPriceRead, error) {
	if e.loadedTypes[5] {
		return e.AnnouncementGroupPriceReads, nil
	}
	return nil, &NotLoadedError{edge: "announcement_group_price_reads"}
}
...
// was not loaded in eager-loading.
func (e UserEdges) TagsOrErr() ([]*UserTag, error) {
	if e.loadedTypes[7] {
		return e.Tags, nil
	}
...
// was not loaded in eager-loading.
func (e UserEdges) UserTagAssignmentsOrErr() ([]*UserTagAssignment, error) {
	if e.loadedTypes[16] {
...
// QueryAnnouncementGroupPriceReads queries the "announcement_group_price_reads" edge of the User entity.
func (_m *User) QueryAnnouncementGroupPriceReads() *AnnouncementGroupPriceReadQuery {
	return NewUserClient(_m.config).QueryAnnouncementGroupPriceReads(_m)
}
...
func (_m *User) QueryTags() *UserTagQuery {
...
// QueryUserTagAssignments queries the "user_tag_assignments" edge of the User entity.
func (_m *User) QueryUserTagAssignments() *UserTagAssignmentQuery {
	return NewUserClient(_m.config).QueryUserTagAssignments(_m)
}
