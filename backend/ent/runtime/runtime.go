...
func init() {
	...
	grokvideojobFields := schema.GrokVideoJob{}.Fields()
	_ = grokvideojobFields
	// grokvideojobDescRequestID is the schema descriptor for request_id field.
	grokvideojobDescRequestID := grokvideojobFields[0].Descriptor()
	// grokvideojob.RequestIDValidator is a validator for the "request_id" field. It is called by the builders before save.
	grokvideojob.RequestIDValidator = grokvideojobDescRequestID.Validators[0].(func(string) error)
	// grokvideojobDescModel is the schema descriptor for model field.
	grokvideojobDescModel := grokvideojobFields[5].Descriptor()
	// grokvideojob.DefaultModel holds the default value on creation for the model field.
	grokvideojob.DefaultModel = grokvideojobDescModel.Default.(string)
	// grokvideojob.ModelValidator is a validator for the "model" field. It is called by the builders before save.
	grokvideojob.ModelValidator = grokvideojobDescModel.Validators[0].(func(string) error)
	// grokvideojobDescPromptPreview is the schema descriptor for prompt_preview field.
	grokvideojobDescPromptPreview := grokvideojobFields[6].Descriptor()
	// grokvideojob.DefaultPromptPreview holds the default value on creation for the prompt_preview field.
	grokvideojob.DefaultPromptPreview = grokvideojobDescPromptPreview.Default.(string)
	// grokvideojob.PromptPreviewValidator is a validator for the "prompt_preview" field. It is called by the builders before save.
	grokvideojob.PromptPreviewValidator = grokvideojobDescPromptPreview.Validators[0].(func(string) error)
	// grokvideojobDescStatus is the schema descriptor for status field.
	grokvideojobDescStatus := grokvideojobFields[7].Descriptor()
	// grokvideojob.DefaultStatus holds the default value on creation for the status field.
	grokvideojob.DefaultStatus = grokvideojobDescStatus.Default.(string)
	// grokvideojob.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	grokvideojob.StatusValidator = grokvideojobDescStatus.Validators[0].(func(string) error)
	// grokvideojobDescProgressPercent is the schema descriptor for progress_percent field.
	grokvideojobDescProgressPercent := grokvideojobFields[8].Descriptor()
	// grokvideojob.DefaultProgressPercent holds the default value on creation for the progress_percent field.
	grokvideojob.DefaultProgressPercent = grokvideojobDescProgressPercent.Default.(int)
	// grokvideojobDescProgressText is the schema descriptor for progress_text field.
	grokvideojobDescProgressText := grokvideojobFields[9].Descriptor()
	// grokvideojob.DefaultProgressText holds the default value on creation for the progress_text field.
	grokvideojob.DefaultProgressText = grokvideojobDescProgressText.Default.(string)
	// grokvideojob.ProgressTextValidator is a validator for the "progress_text" field. It is called by the builders before save.
	grokvideojob.ProgressTextValidator = grokvideojobDescProgressText.Validators[0].(func(string) error)
	// grokvideojobDescLastErrorCode is the schema descriptor for last_error_code field.
	grokvideojobDescLastErrorCode := grokvideojobFields[13].Descriptor()
	// grokvideojob.LastErrorCodeValidator is a validator for the "last_error_code" field. It is called by the builders before save.
	grokvideojob.LastErrorCodeValidator = grokvideojobDescLastErrorCode.Validators[0].(func(string) error)
	// grokvideojobDescCreatedAt is the schema descriptor for created_at field.
	grokvideojobDescCreatedAt := grokvideojobFields[15].Descriptor()
	// grokvideojob.DefaultCreatedAt holds the default value on creation for the created_at field.
	grokvideojob.DefaultCreatedAt = grokvideojobDescCreatedAt.Default.(func() time.Time)
	// grokvideojobDescUpdatedAt is the schema descriptor for updated_at field.
	grokvideojobDescUpdatedAt := grokvideojobFields[16].Descriptor()
	// grokvideojob.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	grokvideojob.DefaultUpdatedAt = grokvideojobDescUpdatedAt.Default.(func() time.Time)
	// grokvideojob.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	grokvideojob.UpdateDefaultUpdatedAt = grokvideojobDescUpdatedAt.UpdateDefault.(func() time.Time)
	// grokvideojobDescSubmittedAt is the schema descriptor for submitted_at field.
	grokvideojobDescSubmittedAt := grokvideojobFields[17].Descriptor()
	// grokvideojob.DefaultSubmittedAt holds the default value on creation for the submitted_at field.
	grokvideojob.DefaultSubmittedAt = grokvideojobDescSubmittedAt.Default.(func() time.Time)
	...
	// groupDescLimitedTimeMultiplierEnabled is the schema descriptor for limited_time_multiplier_enabled field.
	groupDescLimitedTimeMultiplierEnabled := groupFields[3].Descriptor()
	// group.DefaultLimitedTimeMultiplierEnabled holds the default value on creation for the limited_time_multiplier_enabled field.
	group.DefaultLimitedTimeMultiplierEnabled = groupDescLimitedTimeMultiplierEnabled.Default.(bool)
	// groupDescLimitedTimeMultiplierCron is the schema descriptor for limited_time_multiplier_cron field.
	groupDescLimitedTimeMultiplierCron := groupFields[4].Descriptor()
	// group.DefaultLimitedTimeMultiplierCron holds the default value on creation for the limited_time_multiplier_cron field.
	group.DefaultLimitedTimeMultiplierCron = groupDescLimitedTimeMultiplierCron.Default.(string)
	// group.LimitedTimeMultiplierCronValidator is a validator for the "limited_time_multiplier_cron" field. It is called by the builders before save.
	group.LimitedTimeMultiplierCronValidator = groupDescLimitedTimeMultiplierCron.Validators[0].(func(string) error)
	// groupDescLimitedTimeMultiplierDurationMinutes is the schema descriptor for limited_time_multiplier_duration_minutes field.
	groupDescLimitedTimeMultiplierDurationMinutes := groupFields[5].Descriptor()
	// group.DefaultLimitedTimeMultiplierDurationMinutes holds the default value on creation for the limited_time_multiplier_duration_minutes field.
	group.DefaultLimitedTimeMultiplierDurationMinutes = groupDescLimitedTimeMultiplierDurationMinutes.Default.(int)
	// groupDescLimitedTimeMultiplierValue is the schema descriptor for limited_time_multiplier_value field.
	groupDescLimitedTimeMultiplierValue := groupFields[6].Descriptor()
	// group.DefaultLimitedTimeMultiplierValue holds the default value on creation for the limited_time_multiplier_value field.
	group.DefaultLimitedTimeMultiplierValue = groupDescLimitedTimeMultiplierValue.Default.(float64)
	// groupDescLimitedTimeRpmLimit is the schema descriptor for limited_time_rpm_limit field.
	groupDescLimitedTimeRpmLimit := groupFields[7].Descriptor()
	// group.DefaultLimitedTimeRpmLimit holds the default value on creation for the limited_time_rpm_limit field.
	group.DefaultLimitedTimeRpmLimit = groupDescLimitedTimeRpmLimit.Default.(int)
	// groupDescLimitedTimeUserConcurrencyLimit is the schema descriptor for limited_time_user_concurrency_limit field.
	groupDescLimitedTimeUserConcurrencyLimit := groupFields[8].Descriptor()
	// group.DefaultLimitedTimeUserConcurrencyLimit holds the default value on creation for the limited_time_user_concurrency_limit field.
	group.DefaultLimitedTimeUserConcurrencyLimit = groupDescLimitedTimeUserConcurrencyLimit.Default.(int)
	// groupDescPeakRateEnabled is the schema descriptor for peak_rate_enabled field.
	groupDescPeakRateEnabled := groupFields[9].Descriptor()
	...
	groupDescPeakStart := groupFields[10].Descriptor()
	...
	groupDescPeakEnd := groupFields[11].Descriptor()
	...
	groupDescPeakRateMultiplier := groupFields[12].Descriptor()
	...
	groupDescIsExclusive := groupFields[13].Descriptor()
	...
	groupDescStatus := groupFields[14].Descriptor()
	...
	groupDescBatchImageDiscountMultiplier := groupFields[28].Descriptor()
	...
	groupDescBatchImageHoldMultiplier := groupFields[29].Descriptor()
	...
	groupDescVideoRateIndependent := groupFields[30].Descriptor()
	...
	groupDescVideoRateMultiplier := groupFields[31].Descriptor()
	...
	groupDescUserConcurrencyLimit := groupFields[51].Descriptor()
	...
	// subscriptionplanDescNewUserOnly is the schema descriptor for new_user_only field.
	subscriptionplanDescNewUserOnly := subscriptionplanFields[12].Descriptor()
	// subscriptionplan.DefaultNewUserOnly holds the default value on creation for the new_user_only field.
	subscriptionplan.DefaultNewUserOnly = subscriptionplanDescNewUserOnly.Default.(bool)
	// subscriptionplanDescPurchaseLimitCount is the schema descriptor for purchase_limit_count field.
	subscriptionplanDescPurchaseLimitCount := subscriptionplanFields[13].Descriptor()
	// subscriptionplan.DefaultPurchaseLimitCount holds the default value on creation for the purchase_limit_count field.
	subscriptionplan.DefaultPurchaseLimitCount = subscriptionplanDescPurchaseLimitCount.Default.(int)
	// subscriptionplanDescIPPurchaseLimitCount is the schema descriptor for ip_purchase_limit_count field.
	subscriptionplanDescIPPurchaseLimitCount := subscriptionplanFields[14].Descriptor()
	// subscriptionplan.DefaultIPPurchaseLimitCount holds the default value on creation for the ip_purchase_limit_count field.
	subscriptionplan.DefaultIPPurchaseLimitCount = subscriptionplanDescIPPurchaseLimitCount.Default.(int)
	// subscriptionplanDescStockCount is the schema descriptor for stock_count field.
	subscriptionplanDescStockCount := subscriptionplanFields[15].Descriptor()
	// subscriptionplan.DefaultStockCount holds the default value on creation for the stock_count field.
	subscriptionplan.DefaultStockCount = subscriptionplanDescStockCount.Default.(int)
	// subscriptionplanDescFirstPurchaseDiscountEnabled is the schema descriptor for first_purchase_discount_enabled field.
	subscriptionplanDescFirstPurchaseDiscountEnabled := subscriptionplanFields[16].Descriptor()
	// subscriptionplan.DefaultFirstPurchaseDiscountEnabled holds the default value on creation for the first_purchase_discount_enabled field.
	subscriptionplan.DefaultFirstPurchaseDiscountEnabled = subscriptionplanDescFirstPurchaseDiscountEnabled.Default.(bool)
	// subscriptionplanDescSortOrder is the schema descriptor for sort_order field.
	subscriptionplanDescSortOrder := subscriptionplanFields[18].Descriptor()
