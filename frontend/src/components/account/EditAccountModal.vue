<template>
  ...
  >
    ...
    >
      ...
      <div v-if="account.type === 'oauth'" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          <div>
            <label class="input-label mb-0">{{ t('admin.accounts.poolMode') }}</label>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
...
const defaultBaseUrl = computed(() => {
  ...
  if (props.account?.platform === 'seedance') return 'https://model.service-inference.ai'
...
const loadPoolModeConfig = (credentials?: Record<string, unknown>) => {
...
const syncFormFromAccount = (newAccount: Account | null) => {
  ...
  loadPoolModeConfig(credentials)
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (props.account.type === 'apikey') {
      ...
      applyPoolModeConfig(newCredentials)
