...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'grok' | 'seedance' | 'composite'
...
const BADGE: Record<Platform, string> = {
  ...
  seedance: 'bg-rose-500/10 text-rose-700 border-rose-500/30 dark:text-rose-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  seedance: 'bg-rose-500/10 text-rose-700 dark:text-rose-300',
...
const BORDER: Record<Platform, string> = {
  ...
  seedance: 'border-rose-500/20 dark:border-rose-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  seedance: 'border-rose-500/35 dark:border-rose-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  seedance: 'bg-gradient-to-r from-rose-500 to-red-600',
...
const TEXT: Record<Platform, string> = {
  ...
  seedance: 'text-rose-700 dark:text-rose-300',
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-800 dark:text-zinc-200',
  seedance: 'text-rose-600 dark:text-rose-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  seedance: 'bg-rose-600 text-white hover:bg-rose-700 active:bg-rose-800 dark:bg-rose-600 dark:hover:bg-rose-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  seedance: 'bg-rose-100 text-rose-800 dark:bg-rose-900/40 dark:text-rose-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  seedance: 'from-rose-500 to-red-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'grok' || p === 'seedance' || p === 'composite'
}
