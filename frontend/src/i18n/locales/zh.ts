export default {
  ...
  imagePlayground: {
    eyebrow: '在线生图',
    title: '在线生图',
    description: '使用你创建的支持生图 API Key 生成或编辑图片。生成结果会保存在当前浏览器本地。',
    loading: '正在加载生图配置...',
    ready: '选择 Key，填写描述并开始生成。',
    emptyStateTitle: '暂无支持生图的 Key',
    emptyStateDescription: '请先创建一个可访问生图模型的 API Key，再使用在线生图。',
    generatorTitle: '生成参数',
    generatorDescription: '选择 Key，选择或输入模型，并配置图片输出参数。',
    apiKeyLabel: 'API Key',
    ...
    referenceLabel: '参考图',
    referenceDropTitle: '拖拽参考图到这里，或点击选择文件',
    referenceBrowseAction: '选择图片',
    referenceHint: '可选。上传参考图将使用图片编辑模式。单个文件不能超过 20MB。',
    referenceEditHint: '已选择参考图，本次请求将使用图片编辑模式。',
    referenceListLabel: '已选择的参考图',
    fileTooLarge: '文件过大',
    removeReferenceLabel: '移除参考图',
    removeReferenceAction: '移除',
    sizeLabel: '尺寸',
    sizePickerTitle: '设置图像尺寸',
    sizePickerCurrent: '当前',
    sizePickerAutoTab: '自动',
    sizePickerRatioTab: '按比例',
    sizePickerCustomTab: '自定义宽高',
    sizePickerAutoTitle: '自动尺寸',
    sizePickerAutoDescription: '不向模型传递具体的分辨率参数，由模型自己决定生成尺寸。',
    sizePickerResolutionLabel: '基准分辨率',
    sizePickerRatioLabel: '图像比例',
    sizePickerCustomRatioAction: '自定义比例',
    sizePickerCustomInputLabel: '输入具体像素值',
    sizePickerWidthLabel: '宽度 (Width)',
    sizePickerHeightLabel: '高度 (Height)',
    sizePickerLimitHint: '由于模型限制，最终输出会自动规整到合法尺寸：宽高均为 16 的倍数，最大边长 3840px，宽高比不超过 3:1，总像素限制为 655360-8294400。',
    sizePickerWillUse: '将使用',
    sizePickerCancel: '取消',
    sizePickerConfirm: '确定',
    qualityLabel: '质量',
    outputFormatLabel: '格式',
    compressionLabel: '压缩率',
    compressionPlaceholder: '0-100',
    compressionInvalid: '压缩率必须是 0 到 100 的整数。',
    moderationLabel: '审核',
    countLabel: '数量',
    countInvalid: '数量必须是正整数。',
    streamLabel: '流式响应',
    streamHint: '长耗时 OpenAI 生图会持续接收响应，避免超时风险。',
    streamUnsupportedHint: '流式仅支持无参考图的 OpenAI gpt-image 生图。',
    submitHint: '浏览器不会暴露完整 API Key，只会提交所选 Key 的 ID。',
    generatingButton: '生成中...',
    generateButton: '生成图片',
    resultsTitle: '最新结果',
    resultsDescription: '展示最近一次请求生成的图片和价格。',
    resultsEmpty: '生成结果会显示在这里。',
    generatedImageAlt: '生成图片',
    previewImageAction: '预览图片',
    downloadImageAction: '下载',
    imagePreviewTitle: '图片预览',
    closePreviewAction: '关闭预览',
    tipsTitle: '提示',
    tipPrompt: '描述中包含主体、场景、风格、光线和构图会更稳定。',
    tipReference: '需要编辑或风格迁移时，可以上传参考图。',
    tipReuse: '复用历史记录可以快速用相近参数再次生成。',
    historyTitle: '本地历史',
    historyDescription: '生成过的图片会通过 IndexedDB 保存在当前浏览器本地。',
    clearHistoryButton: '清空历史',
    historyEmpty: '暂无已保存的生成图片。',
    reuseParamsButton: '复用参数',
    deleteHistoryButton: '删除',
    loadOptionsFailed: '加载生图配置失败。',
    loadHistoryFailed: '加载本地图片历史失败。',
    referenceTooLargeError: '有参考图超过 20MB，请移除超大文件后再生成。',
    referenceAddedStatus: '参考图已添加。',
    generatingStatus: '正在生成图片，请稍候...',
    streamingStatus: '正在以流式模式生成图片，请保持页面打开...',
    streamingProgressStatus: '正在接收流式生图结果...',
    generationProgressLabel: '生成进度',
    generationProgressIndeterminate: '生成中',
    generationProgressPercent: '{percent}%',
    generationProgressImages: '已收到 {count}/{total} 张图片',
    previewZoomControlsLabel: '预览缩放控制',
    previewZoomInAction: '放大',
    previewZoomOutAction: '缩小',
    previewZoomResetAction: '重置',
    previewPanHint: '可拖动移动图片。',
    generateSuccessStatus: '图片生成成功。',
    generateEmptyStatus: '请求已完成，但没有返回图片。',
    generateFailed: '图片生成失败，请检查所选 Key、模型和参数。',
    reuseParamsStatus: '已应用历史参数。',
    historyDeletedStatus: '历史记录已删除。',
    historyDeleteFailed: '删除历史记录失败。',
    historyClearedStatus: '历史已清空。',
  ...
  admin: {
    ...
    groups: {
      ...
      columns: {
        ...
        limitedTimeRpmOverrideHint: '限时倍率窗口内该用户在此分组的 RPM 上限；0 = 限时窗口内不限制',
        rateDefault: '默认',
        rpmDefault: '默认',
        exclusive: '独占',
        type: '类型',
      ...
      form: {
        ...
        userConcurrencyLimit: '每用户并发数',
        userConcurrencyLimitPlaceholder: '0 表示不限制',
        userConcurrencyLimitHint: '每个用户在本分组内允许同时进行的最大请求数，0 = 不限制',
        exclusiveLabel: '专属分组',
      ...
      limitedTimeMultiplier: {
        title: '限时倍率',
        hint: '仅标准（余额）计费分组生效。到达指定开始时间后，在持续时间内若限时倍率低于当前结算倍率，则按限时倍率结算；不会抬高更低的用户专属倍率。',
        startTime: '开始时间',
        startTimeHint: '选择每天、每周或每月的开始时间，系统会自动生成 cron 表达式。',
        hourOption: '{hour} 点',
        minuteOption: '{minute} 分',
        value: '费率倍数',
        duration: '持续时间',
        durationUnit: '时间单位',
        limitedTimeRpmLimit: '限时 RPM',
        limitedTimeRpmLimitPlaceholder: '0 表示不设置专属限制',
        limitedTimeRpmLimitHint: '限时倍率窗口内每用户在本分组每分钟最大请求数；0 表示不设置专属限时 RPM，回落普通 RPM 规则；用户专属限时 RPM 覆盖值优先级更高。',
        limitedTimeUserConcurrencyLimit: '限时每用户并发数',
        limitedTimeUserConcurrencyLimitPlaceholder: '0 表示不设置专属限制',
        limitedTimeUserConcurrencyLimitHint: '限时倍率窗口内每个用户在本分组允许同时进行的最大请求数；0 表示不设置专属限时并发，回落普通每用户并发规则。',
        tableBadge: '限时 {value}x · {schedule} {timeRange} {active}',
        effectiveTooltip: '限时倍率生效中，{limited}x 低于当前用户倍率 {normal}x，本次按 {limited}x 结算。',
        effectiveTooltipDefault: '限时倍率生效中，本次按 {limited}x 结算。',
        frequency: {
          daily: '每天',
          weekly: '每周',
          monthly: '每月'
      ...
      rpmSaved: '专属 RPM 已保存',
      limitedTimeRpmOverrides: '限时 RPM',
      limitedTimeRpmOverridesTitle: '限时倍率专属 RPM 管理',
      addUserLimitedTimeRpm: '添加限时专属 RPM',
      noLimitedTimeRpmOverrides: '暂无用户设置了限时专属 RPM',
      limitedTimeRpmSaved: '限时专属 RPM 已保存',
      limitedTimeRpmHint: '仅在该分组限时倍率窗口生效时使用；0 表示限时窗口内该用户此分组不限 RPM，但用户全局 RPM 仍会生效。',
      groupRpmDefault: '分组默认 RPM',
      limitedTimeGroupRpmDefault: '限时默认 RPM',
    ...
    accounts: {
      ...
      bulkHighestSchedulingEnabled: '成功启用 {count} 个账号的最高调度模式',
      bulkHighestSchedulingDisabled: '成功关闭 {count} 个账号的最高调度模式',
      bulkHighestSchedulingPartial: '部分最高调度更新成功：成功 {success} 个，失败 {failed} 个',
      bulkHighestSchedulingResultUnknown: '批量最高调度结果不完整，请稍后重试或刷新列表',
      highestSchedulingEnabled: '最高调度模式已开启',
      highestSchedulingDisabled: '最高调度模式已关闭',
      failedToToggleHighestScheduling: '切换最高调度模式失败',
      enableHighestSchedulingAction: '开启最高调度模式',
      disableHighestSchedulingAction: '关闭最高调度模式',
      highestSchedulingOn: '已开启',
      highestSchedulingOff: '已关闭',
      bulkActions: {
        ...
        enableHighestScheduling: '批量开启最高调度',
        disableHighestScheduling: '批量关闭最高调度',
        resetStatus: '批量重置状态',
        refreshToken: '批量刷新令牌',
      ...
      bulkEdit: {
        ...
        highestSchedulingHint: '批量编辑时可统一开启或关闭最高调度，并可设置错误后的恢复时间。'
      },
      ...
      highestSchedulingMode: '最高调度模式',
      highestSchedulingModeHint:
        '账号满足既有分组、模型、额度、并发等调度条件时，会优先于普通账号被选择；满载、阻塞或错误时仍正常回退。',
      highestSchedulingRecoveryMinutes: '错误后恢复时间（分钟）',
      highestSchedulingRecoveryMinutesHint: '0 或留空表示账号错误后持续暂停最高调度，需要管理员手动恢复。',
      highestSchedulingSuppressed: '该账号因错误已暂停最高调度偏好。',
      highestSchedulingSuppressedUntil: '将在 {time} 后恢复最高调度偏好（账号本身仍需可调度）。',
      highestSchedulingSuppressedManual: '需要手动恢复后，该账号才会重新获得最高调度偏好。',
      highestSchedulingManualResume: '立即恢复最高调度',
      highestSchedulingSuppressedReason: '原因：{reason}',
    ...
    settings: {
      ...
      site: {
        ...
        contactInfo: '客服联系方式',
        contactInfoPlaceholder: '例如：<a href="https://t.me/example" target="_blank" rel="noopener noreferrer">Telegram 客服</a>',
        contactInfoHint: '填写客服联系方式，支持 HTML，将展示在右上角下拉、兑换页面、个人资料等位置',
        docUrl: '文档链接',
  ...
  payment: {
    ...
    errors: {
      ...
      PLAN_PURCHASE_LIMIT_REACHED: '该套餐已达到你的购买次数上限。',
      PLAN_PURCHASE_LIMIT_INVALID: '购买次数上限必须大于等于 0。',
      PLAN_IP_PURCHASE_LIMIT_REACHED: '不符合购买条件。',
      PLAN_IP_PURCHASE_LIMIT_INVALID: '同 IP 购买次数上限必须大于等于 0。',
      PLAN_STOCK_INVALID: '库存必须大于等于 0。',
      PLAN_OUT_OF_STOCK: '该套餐库存不足。',
      PLAN_NEW_USER_ONLY: '该套餐仅限上架后注册的新用户购买。',
      PLAN_FIRST_PURCHASE_DISCOUNT_INVALID: '首次优惠价格无效。',
    ...
    renewNow: '续费',
    selectPlan: '选择套餐',
    firstPurchaseDiscount: '首次优惠',
    firstOrderSpecial: '首单特惠',
    planFeatures: '功能特性',
    planCount: '个套餐',
    planCard: {
      rate: '倍率',
      ...
      stockEnough: '库存充足',
      stockLow: '库存紧张',
      stockLowWithCount: '库存紧张（{count}件）',
      newUserOnly: '新用户专享',
      newUserOnlyHint: '仅限上架后注册的新用户购买。',
      notEligible: '不符合购买条件',
      ipLimitReached: '不符合购买条件',
      offSaleCountdown: '下架倒计时',
      offSold: '已下架',
      countdownDays: '{days}天 {time}',
      countdownTime: '{time}',
      limitReached: '已达上限',
      models: '模型',
    },
    ...
    admin: {
      ...
      originalPrice: '原价',
      price: '价格',
      purchaseLimitCount: '购买上限/用户',
      purchaseLimitCountHint: '0 为无限制。',
      ipPurchaseLimitCount: '同 IP 购买上限',
      ipPurchaseLimitCountHint: '0 为无限制。',
      stockCount: '库存',
      soldOut: '已售完',
      newUserOnly: '新用户限购',
      newUserOnlyHint: '启用后，仅注册时间不早于套餐上架时间的用户可购买。',
      listedAt: '上架时间',
      listedAtHint: '用于新用户限购判断；重新上架且留空时，服务端会自动设置为当前时间。',
      firstPurchaseDiscountEnabled: '首次优惠',
      firstPurchaseDiscountPrice: '首次优惠价格',
      firstPurchaseDiscountPriceInvalid: '首次优惠价格必须大于 0 且小于基础价格',
      ...
      forSale: '上架状态',
      offSaleAt: '下架时间',
      offSaleAtHint: '到达该时间后套餐自动下架；留空则不自动下架。',
      onSale: '上架',
      offSale: '下架',
      group: '分组',
      groupId: '分组 ID',
