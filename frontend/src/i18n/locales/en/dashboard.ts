export default {
  ...
  keys: {
    ...
    groupOrderHint: 'If a group is unavailable, fallback follows the numbered order',
  ...
  affiliate: {
    ...
    withdrawal: {
      ...
      accounts: {
        ...
        description: 'Save Alipay accounts and select one when withdrawing instead of entering it each time.',
        add: 'Add Account',
        addTitle: 'Add Alipay Account',
        editTitle: 'Update Alipay Account',
        editHint: 'For security, enter the complete Alipay account again.',
        empty: 'No saved payout accounts',
        emptyHint: 'Add an Alipay account before requesting a withdrawal.',
        addNow: 'Add now',
        selectPlaceholder: 'Select a payout account',
        selectionHint: 'Each request keeps an account snapshot, so later changes do not affect withdrawal history.',
        default: 'Default',
        setDefault: 'Set Default',
        limit: 'You can save up to 10 payout accounts.',
        createSuccess: 'Payout account added',
        updateSuccess: 'Payout account updated',
        saveFailed: 'Failed to save payout account',
        defaultSuccess: 'Default payout account updated',
        defaultFailed: 'Failed to set default payout account',
        deleteTitle: 'Delete Payout Account',
        deleteConfirm: 'Delete Alipay account {account}? Existing withdrawal records will not be affected.',
        deleteSuccess: 'Payout account deleted',
        deleteFailed: 'Failed to delete payout account',
        loadFailed: 'Failed to load payout accounts'
      },
