export default {
    accounts: {
      ...
      highestSchedulingModeHint: 'Prioritizes candidates that already satisfy account status and schedulability requirements.',
      enableHighestSchedulingAction: 'Enable highest scheduling',
      disableHighestSchedulingAction: 'Disable highest scheduling',
      highestSchedulingEnabled: 'Highest scheduling enabled',
      highestSchedulingDisabled: 'Highest scheduling disabled',
      failedToToggleHighestScheduling: 'Failed to toggle highest scheduling',
      bulkHighestSchedulingEnabled: 'Enabled highest scheduling for {count} account(s)',
      bulkHighestSchedulingDisabled: 'Disabled highest scheduling for {count} account(s)',
      bulkHighestSchedulingPartial: 'Highest scheduling partially updated: {success} succeeded, {failed} failed',
      bulkHighestSchedulingResultUnknown: 'Bulk highest scheduling result is incomplete. Please retry or refresh.',
      highestSchedulingRotation: {
        shortTitle: 'Highest Rotation',
        title: 'Highest Scheduling Rotation',
        description: 'Automatically keeps the configured number of highest-scheduling accounts in the selected groups and account types.',
        enabled: 'Enable rotation',
        enabledHint: 'When enabled, rotation manages highest scheduling in scope and fills vacancies when candidates become unavailable.',
        groups: 'Group scope',
        groupsHint: 'Selecting no specific group means all grouped and ungrouped accounts.',
        accountTypes: 'Account types',
        rotationCount: 'Rotation count',
        activeCount: 'Current highest-scheduling accounts',
        candidateCount: 'Eligible accounts',
        managedHint: 'When rotation is enabled, accounts in scope cannot be manually toggled; disabling rotation clears highest scheduling in scope.',
        managedToggleHint: 'This account is managed by highest scheduling rotation and cannot be toggled manually.',
        managedBulkHint: 'The selection includes rotation-managed accounts, so highest scheduling cannot be toggled in bulk.',
        reconcile: 'Sync now',
        saved: 'Highest scheduling rotation saved',
        reconciled: 'Highest scheduling rotation synced',
        loadFailed: 'Failed to load highest scheduling rotation',
        saveFailed: 'Failed to save highest scheduling rotation',
        reconcileFailed: 'Failed to sync highest scheduling rotation'
      },
      ...
      columns: {
        ...
        status: 'Status',
        schedulable: 'Schedulable',
        highestScheduling: 'Highest Scheduling',
...
rateSyncWarning: 'Accounts with upstream rate sync enabled cannot be changed in bulk. Disable sync in the account editor first.',
        ...
        poolModeNotice: 'Applies to OAuth, API Key, and Bedrock accounts; once checked, pool mode will be enabled or disabled in bulk.',
        invalidPoolModeRetryStatusCodes: 'Same-account retry status codes must be integers from 100 to 599, separated by commas or spaces',
