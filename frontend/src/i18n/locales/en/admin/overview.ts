export default {
    ...
    users: {
      ...
      tagsPlaceholder: 'Select user tags',
      tagNamePlaceholder: 'Enter tag name',
      noTags: 'No user tags',
      tagManagement: 'User Tag Management',
      deleteTag: 'Delete User Tag',
      deleteTagConfirm: 'Delete tag "{name}"? Existing user and group-derived access will be revoked.',
      failedToLoadTags: 'Failed to load user tags',
      failedToCreateTag: 'Failed to create user tag',
      failedToUpdateTag: 'Failed to rename user tag',
      failedToDeleteTag: 'Failed to delete user tag',
      viewTagUsers: 'View Users',
      tagUsersTitle: 'Users with "{name}"',
      addUsersToTagTitle: 'Add Users to "{name}"',
      addUsers: 'Add Users',
      addSelectedUsers: 'Add Selected Users',
      selectedUsers: '{count} users selected',
      searchTagUsers: 'Search email or username',
      tagUserStatus: 'User status',
      noTagUsers: 'No users have this tag',
      noUsersToAdd: 'No users to add',
      noUsername: 'No username',
      tagUsersLimit: '{count} users selected; up to 500 per request',
      failedToLoadTagUsers: 'Failed to load tagged users',
      failedToAddTagUsers: 'Failed to add users to tag',
      tagUsersAdded: '{count} users added to tag',
      apiKeys: 'API Keys',
    ...
    groups: {
      ...
      form: {
        ...
        tags: 'User tag authorization',
        tagsPlaceholder: 'Select one or more user tags',
        tagsHint: 'Users with any selected tag will automatically get this exclusive group',
