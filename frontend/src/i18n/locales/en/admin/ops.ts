export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholds: 'Health Metric Thresholds',
        metricThresholdsHint: 'Used for ops health evaluation and diagnostics. Changes apply to subsequent evaluations.',
        slaMinPercent: 'Minimum SLA (%)',
        slaMinPercentHint: 'SLA below this percentage is considered unhealthy.',
        ttftP99MaxMs: 'Maximum TTFT P99 (ms)',
        ttftP99MaxMsHint: 'First-token latency above this value is considered unhealthy.',
        requestErrorRateMaxPercent: 'Maximum Request Error Rate (%)',
        requestErrorRateMaxPercentHint: 'Request error rates above this percentage are considered unhealthy.',
        upstreamErrorRateMaxPercent: 'Maximum Upstream Error Rate (%)',
        upstreamErrorRateMaxPercentHint: 'Upstream error rates above this percentage are considered unhealthy.',
        silencing: {
