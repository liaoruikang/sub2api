...
modelPlaza: {
        ...
        imagePlayground: {
          ...
          description: 'Control the user-facing image generation page. Enabled by default.',
          enabled: 'Enable Image Playground',
          enabledHint: 'When off, the user sidebar entry is hidden and direct page visits are blocked.',
        },
        videoJobs: {
          title: 'Video Jobs',
          description: 'Control the user-facing video jobs page. Enabled by default.',
          enabled: 'Enable Video Jobs',
          enabledHint: 'When off, the user sidebar entry is hidden and direct page visits are blocked.',
        },
        riskControl: {
          title: 'Risk Control',
        ...
        affiliate: {
          ...
          withdrawalEnabled: 'Enable Affiliate Withdrawals',
          withdrawalEnabledHint: 'Allow users to request Alipay withdrawals. Disabling this does not block processing existing requests.',
          withdrawalMinAmount: 'Minimum Withdrawal',
          withdrawalMinAmountHint: 'Each withdrawal request must be at least this amount.',
          withdrawalFeeRate: 'Withdrawal Fee',
          withdrawalFeeRateHint: 'Percentage of the requested amount. For $100 at 1%, $100 is frozen and $99 is paid.',
