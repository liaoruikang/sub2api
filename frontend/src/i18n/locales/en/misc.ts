export default {
  ...
  imagePlayground: {
    ...
    description: 'Generate, edit, and manage image history with OpenAI-compatible image models.',
    loading: 'Loading...',
    ready: 'Ready',
    emptyStateTitle: 'Start creating images',
    emptyStateDescription: 'Select an API key and model, then enter a prompt to generate images.',
    generatorTitle: 'Image Generator',
    generatorDescription: 'Configure the model, references, size, and output options.',
    apiKeyLabel: 'API Key',
    ...
    referenceDropTitle: 'Drop images here',
    referenceHint: 'Upload references for image editing or style guidance.',
    referenceBrowseAction: 'Choose images',
    referenceEditHint: 'Uploading references automatically switches to edit mode.',
    referenceListLabel: 'Reference image list',
    ...
    compressionLabel: 'Compression Quality',
    compressionPlaceholder: '0-100',
    compressionInvalid: 'Compression quality must be between 0 and 100.',
    moderationLabel: 'Moderation',
    countLabel: 'Image Count',
    countInvalid: 'Image count must be between 1 and 10.',
    streamLabel: 'Stream generation',
    streamHint: 'Show generation progress in real time when enabled.',
    streamUnsupportedHint: 'The current model or configuration does not support streaming.',
    advancedModeLabel: 'Advanced mode',
    advancedModeHint: 'View and edit the API path and JSON request body. Valid changes sync back to the form.',
    advancedPathLabel: 'API path',
    advancedPathHint: 'Supports /v1/images/generations and /v1/images/edits. The browser still sends through the current site proxy.',
    advancedBodyLabel: 'Request body JSON',
    advancedFormatAction: 'Format JSON',
    advancedInvalidPath: 'API path only supports /v1/images/generations or /v1/images/edits.',
    advancedEditRequiresReference: 'Using /v1/images/edits requires at least one reference image.',
    advancedGenerationRejectsReference: 'Using /v1/images/generations cannot include reference images. Remove references or switch to /v1/images/edits.',
    advancedInvalidJSON: 'Request body is not valid JSON.',
    advancedJSONMustBeObject: 'Request body JSON must be an object.',
    advancedInvalidApiKey: 'api_key_id is invalid or unavailable.',
    advancedInvalidModel: 'model cannot be empty.',
    advancedInvalidPrompt: 'prompt cannot be empty.',
    advancedResultTitle: 'Advanced request details',
    advancedResultDescription: 'View the last generation request, upstream response, or failure details.',
    advancedLastRequestLabel: 'Last request',
    advancedLastResponseLabel: 'Last response / error',
    advancedNoData: 'No data yet',
    streamingStatus: 'Receiving generation progress...',
    streamingProgressStatus: 'Generation progress: {progress}',
    generationProgressLabel: 'Generation Progress',
    generationProgressIndeterminate: 'Generating...',
    generationProgressPercent: '{percent}%',
    generationProgressImages: '{count} image(s) generated',
    submitHint: 'Select an API key and model, then enter a prompt first.',
    generatingButton: 'Generating...',
    generateButton: 'Generate Images',
    resultsTitle: 'Results',
    resultsDescription: 'View, preview, or download images from this generation.',
    ...
    tipsTitle: 'Tips',
    tipPrompt: 'Specific prompts usually produce more stable results.',
    tipReference: 'Add reference images for editing, character consistency, or style guidance.',
    tipReuse: 'Reuse parameters from history to generate again quickly.',
    historyTitle: 'History',
    historyDescription: 'Review recent image generation records.',
    clearHistoryButton: 'Clear History',
    historyEmpty: 'No history yet',
    reuseParamsButton: 'Reuse Params',
    deleteHistoryButton: 'Delete Record',
    sizePickerTitle: 'Choose image size',
    sizePickerCurrent: 'Current size',
    sizePickerAutoTab: 'Auto',
    sizePickerRatioTab: 'Ratio',
    sizePickerCustomTab: 'Custom',
    sizePickerAutoTitle: 'Auto size',
    sizePickerAutoDescription: 'Let the model decide the output size from the prompt.',
    sizePickerResolutionLabel: 'Resolution',
    sizePickerRatioLabel: 'Ratio',
    sizePickerCustomRatioAction: 'Custom ratio',
    sizePickerCustomInputLabel: 'Custom size',
    sizePickerWidthLabel: 'Width',
    sizePickerHeightLabel: 'Height',
    sizePickerLimitHint: 'Width and height must stay within the model limits.',
    sizePickerWillUse: 'Will use',
    sizePickerCancel: 'Cancel',
    sizePickerConfirm: 'Confirm',
    imagePreviewTitle: 'Image Preview',
    closePreviewAction: 'Close preview',
    previewZoomControlsLabel: 'Zoom controls',
    previewZoomInAction: 'Zoom in',
    previewZoomOutAction: 'Zoom out',
    previewZoomResetAction: 'Reset zoom',
    previewPanHint: 'Drag the image to pan.',
    loadOptionsFailed: 'Failed to load image generation options',
    loadHistoryFailed: 'Failed to load image history',
    referenceTooLargeError: 'Reference image must not exceed {maxSize}',
    referenceAddedStatus: 'Reference image added',
    generatingStatus: 'Generating images...',
    generateSuccessStatus: 'Image generation completed',
    generateEmptyStatus: 'Generation completed but no images were returned.',
    generateFailed: 'Image generation failed',
    reuseParamsStatus: 'History parameters reused',
    historyDeletedStatus: 'History record deleted',
    historyDeleteFailed: 'Failed to delete history record',
  ...
  payment: {
    ...
    planCard: {
      ...
      stock: 'Stock',
      offSaleCountdown: 'Off sale in',
      countdownDays: '{days}d {time}',
      countdownTime: '{time}',
      offSold: 'Off sale',
      soldOut: 'Sold out',
      stockLowWithCount: '{count} left',
      stockLow: 'Low stock',
      stockEnough: 'In stock',
      limitReached: 'Purchase limit reached',
      notEligible: 'Only new users can purchase',
      ipLimitReached: 'Purchase limit reached for this IP',
    },
    days: 'days',
    weeks: 'weeks',
    months: 'months',
    ...
    admin: {
      ...
      purchaseLimitCount: 'User Purchase Limit',
      purchaseLimitCountHint: 'Maximum purchases per user; 0 means unlimited',
      ipPurchaseLimitCount: 'IP Purchase Limit',
      ipPurchaseLimitCountHint: 'Maximum purchases from the same IP; 0 means unlimited',
      stockCount: 'Stock Count',
      soldOut: 'Sold out',
      newUserOnly: 'New Users Only',
      newUserOnlyHint: 'Only users without prior subscription purchases can buy this plan',
      firstPurchaseDiscountEnabled: 'Enable First Purchase Discount',
      firstPurchaseDiscountPrice: 'First Purchase Price',
      firstPurchaseDiscountPriceInvalid: 'First purchase price must be greater than 0 and lower than the plan price',
      listedAt: 'Listed At',
      listedAtHint: 'Leave empty to list immediately',
      offSaleAt: 'Off Sale At',
      offSaleAtHint: 'Leave empty to keep the plan on sale',
      forSale: 'For Sale',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',
