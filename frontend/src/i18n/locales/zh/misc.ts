export default {
  ...
  imagePlayground: {
    eyebrow: '图片生成',
    title: '在线生图',
    description: '使用 OpenAI 兼容图片模型生成、编辑并管理图片历史。',
    loading: '加载中...',
    ready: '准备就绪',
    emptyStateTitle: '开始一次图片创作',
    emptyStateDescription: '选择 API 密钥和模型，输入提示词后即可生成图片。',
    generatorTitle: '图片生成器',
    generatorDescription: '配置模型、参考图、尺寸和输出参数。',
    apiKeyLabel: 'API 密钥',
    ...
    referenceLabel: '参考图片',
    referenceDropTitle: '拖拽图片到这里',
    referenceHint: '可上传参考图用于图片编辑或风格参考。',
    referenceBrowseAction: '选择图片',
    referenceEditHint: '上传参考图后将自动切换到编辑模式。',
    referenceListLabel: '参考图片列表',
    fileTooLarge: '文件过大',
    removeReferenceLabel: '移除参考图片',
    removeReferenceAction: '移除',
    sizeLabel: '尺寸',
    qualityLabel: '质量',
    outputFormatLabel: '输出格式',
    compressionLabel: '压缩质量',
    compressionPlaceholder: '0-100',
    compressionInvalid: '压缩质量需在 0 到 100 之间。',
    moderationLabel: '审核级别',
    countLabel: '生成数量',
    countInvalid: '生成数量需在 1 到 10 之间。',
    streamLabel: '流式生成',
    streamHint: '开启后会实时显示生成进度。',
    streamUnsupportedHint: '当前模型或配置不支持流式生成。',
    advancedModeLabel: '高级模式',
    advancedModeHint: '查看并编辑接口路径和 JSON 请求参数，合法修改会同步到左侧表单。',
    advancedPathLabel: '接口路径',
    advancedPathHint: '支持 /v1/images/generations 和 /v1/images/edits。实际请求仍通过当前站点代理发送。',
    advancedBodyLabel: '请求参数 JSON',
    advancedFormatAction: '格式化 JSON',
    advancedInvalidPath: '接口路径仅支持 /v1/images/generations 或 /v1/images/edits。',
    advancedEditRequiresReference: '使用 /v1/images/edits 时需要至少上传一张参考图片。',
    advancedGenerationRejectsReference: '使用 /v1/images/generations 时不能携带参考图片，请移除参考图或切换到 /v1/images/edits。',
    advancedInvalidJSON: '请求参数不是合法 JSON。',
    advancedJSONMustBeObject: '请求参数 JSON 必须是对象。',
    advancedInvalidApiKey: 'api_key_id 无效或不可用。',
    advancedInvalidModel: 'model 不能为空。',
    advancedInvalidPrompt: 'prompt 不能为空。',
    advancedResultTitle: '高级请求详情',
    advancedResultDescription: '查看最后一次生成请求、上游响应或失败详情。',
    advancedLastRequestLabel: '最后一次请求',
    advancedLastResponseLabel: '最后一次响应 / 错误',
    advancedNoData: '暂无数据',
    streamingStatus: '正在接收生成进度...',
    streamingProgressStatus: '生成进度：{progress}',
    generationProgressLabel: '生成进度',
    generationProgressIndeterminate: '生成中...',
    generationProgressPercent: '{percent}%',
    generationProgressImages: '已生成 {count} 张图片',
    submitHint: '请先选择 API 密钥、模型并填写提示词。',
    generatingButton: '生成中...',
    generateButton: '生成图片',
    resultsTitle: '生成结果',
    resultsDescription: '查看、预览或下载本次生成的图片。',
    resultsEmpty: '生成完成后图片会显示在这里。',
    previewImageAction: '预览图片',
    downloadImageAction: '下载图片',
    generatedImageAlt: '生成的图片',
    tipsTitle: '使用提示',
    tipPrompt: '提示词越具体，生成结果越稳定。',
    tipReference: '添加参考图可用于编辑、保持角色或风格。',
    tipReuse: '可以从历史记录中复用参数快速再次生成。',
    historyTitle: '历史记录',
    historyDescription: '查看近期图片生成记录。',
    clearHistoryButton: '清空历史',
    historyEmpty: '暂无历史记录',
    reuseParamsButton: '复用参数',
    deleteHistoryButton: '删除记录',
    sizePickerTitle: '选择图片尺寸',
    sizePickerCurrent: '当前尺寸',
    sizePickerAutoTab: '自动',
    sizePickerRatioTab: '比例',
    sizePickerCustomTab: '自定义',
    sizePickerAutoTitle: '自动尺寸',
    sizePickerAutoDescription: '由模型根据提示词自动决定输出尺寸。',
    sizePickerResolutionLabel: '分辨率',
    sizePickerRatioLabel: '比例',
    sizePickerCustomRatioAction: '自定义比例',
    sizePickerCustomInputLabel: '自定义尺寸',
    sizePickerWidthLabel: '宽度',
    sizePickerHeightLabel: '高度',
    sizePickerLimitHint: '宽高需符合模型支持范围。',
    sizePickerWillUse: '将使用',
    sizePickerCancel: '取消',
    sizePickerConfirm: '确认',
    imagePreviewTitle: '图片预览',
    closePreviewAction: '关闭预览',
    previewZoomControlsLabel: '缩放控制',
    previewZoomInAction: '放大',
    previewZoomOutAction: '缩小',
    previewZoomResetAction: '重置缩放',
    previewPanHint: '拖拽图片可平移查看。',
    loadOptionsFailed: '加载图片生成选项失败',
    loadHistoryFailed: '加载图片历史失败',
    referenceTooLargeError: '参考图片不能超过 {maxSize}',
    referenceAddedStatus: '已添加参考图片',
    generatingStatus: '正在生成图片...',
    generateSuccessStatus: '图片生成成功',
    generateEmptyStatus: '生成成功，但没有返回图片。',
    generateFailed: '图片生成失败',
    reuseParamsStatus: '已复用历史参数',
    historyDeletedStatus: '历史记录已删除',
    historyDeleteFailed: '删除历史记录失败',
    historyClearedStatus: '历史记录已清空',
  ...
  payment: {
    ...
    planCard: {
      ...
      purchaseLimit: '限购',
      stock: '库存',
      offSaleCountdown: '距离下架',
      countdownDays: '{days} 天 {time}',
      countdownTime: '{time}',
      offSold: '已下架',
      soldOut: '已售罄',
      stockLowWithCount: '仅剩 {count} 份',
      stockLow: '库存紧张',
      stockEnough: '库存充足',
      limitReached: '已达购买上限',
      notEligible: '仅新用户可购买',
      ipLimitReached: '当前 IP 已达购买上限',
    },
    days: '天',
    weeks: '周',
    months: '个月',
    ...
    admin: {
      ...
      validityUnit: '有效期单位',
      sortOrder: '排序',
      purchaseLimitCount: '用户购买上限',
      purchaseLimitCountHint: '每个用户最多可购买次数，0 表示不限制',
      ipPurchaseLimitCount: 'IP 购买上限',
      ipPurchaseLimitCountHint: '同一 IP 最多可购买次数，0 表示不限制',
      stockCount: '库存数量',
      soldOut: '已售罄',
      newUserOnly: '仅新用户',
      newUserOnlyHint: '开启后仅从未购买过订阅的用户可购买',
      firstPurchaseDiscountEnabled: '启用首购优惠',
      firstPurchaseDiscountPrice: '首购优惠价',
      firstPurchaseDiscountPriceInvalid: '首购优惠价必须大于 0 且低于套餐价格',
      listedAt: '上架时间',
      listedAtHint: '留空表示立即上架',
      offSaleAt: '下架时间',
      offSaleAtHint: '留空表示不自动下架',
      forSale: '上架状态',
      onSale: '上架',
      offSale: '下架',
      group: '分组',
