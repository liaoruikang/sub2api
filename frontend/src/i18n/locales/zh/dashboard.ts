export default {
  ...
  keys: {
    ...
    groupOrderHint: '当前分组不可用时，将按编号顺序自动切换兜底',
    dragGroup: '拖动调整分组顺序',
    moveGroupUp: '上移分组',
    moveGroupDown: '下移分组',
    removeGroup: '移除分组',
  ...
  affiliate: {
    ...
    withdrawal: {
      ...
      accounts: {
        manage: '提现账号',
        title: '提现账号管理',
        description: '保存常用支付宝账号，提现时直接选择，无需重复输入。',
        add: '新增账号',
        addTitle: '新增支付宝账号',
        editTitle: '修改支付宝账号',
        editHint: '为保护账号安全，请重新输入完整支付宝账号。',
        empty: '暂无已保存的提现账号',
        emptyHint: '请先添加支付宝账号。',
        addNow: '立即添加',
        selectPlaceholder: '请选择提现账号',
        selectionHint: '申请提交后将保存当前账号快照，后续修改不会影响历史记录。',
        default: '默认',
        setDefault: '设为默认',
        limit: '最多可保存 10 个提现账号。',
        createSuccess: '提现账号已添加',
        updateSuccess: '提现账号已更新',
        saveFailed: '保存提现账号失败',
        defaultSuccess: '默认提现账号已更新',
        defaultFailed: '设置默认提现账号失败',
        deleteTitle: '删除提现账号',
        deleteConfirm: '确定删除支付宝账号 {account} 吗？历史提现记录不会受影响。',
        deleteSuccess: '提现账号已删除',
        deleteFailed: '删除提现账号失败',
        loadFailed: '加载提现账号失败'
      },
      requestAmount: '冻结金额',
      fee: '手续费（{rate}%）',
