export default {
    ...
    users: {
      ...
      tags: '用户标签',
      manageTags: '管理标签',
      tagsPlaceholder: '选择用户标签',
      tagNamePlaceholder: '输入标签名称',
      noTags: '暂无用户标签',
      tagManagement: '用户标签管理',
      deleteTag: '删除用户标签',
      deleteTagConfirm: '确定要删除标签「{name}」吗？已有用户和分组的自动授权将被撤销。',
      failedToLoadTags: '加载用户标签失败',
      failedToCreateTag: '创建用户标签失败',
      failedToUpdateTag: '重命名用户标签失败',
      failedToDeleteTag: '删除用户标签失败',
      viewTagUsers: '查看用户',
      tagUsersTitle: '标签「{name}」的用户',
      addUsersToTagTitle: '向标签「{name}」添加用户',
      addUsers: '添加用户',
      addSelectedUsers: '添加选中用户',
      selectedUsers: '已选择 {count} 个用户',
      searchTagUsers: '搜索邮箱或用户名',
      tagUserStatus: '用户状态',
      noTagUsers: '该标签暂无用户',
      noUsersToAdd: '没有可添加的用户',
      noUsername: '未设置用户名',
      tagUsersLimit: '已选择 {count} 个用户，单次最多添加 500 个',
      failedToLoadTagUsers: '加载标签用户失败',
      failedToAddTagUsers: '添加用户到标签失败',
      tagUsersAdded: '已向标签添加 {count} 个用户',
      apiKeys: 'API密钥',
    ...
    groups: {
      ...
      form: {
        ...
        tags: '用户标签授权',
        tagsPlaceholder: '选择一个或多个用户标签',
        tagsHint: '拥有任意一个所选标签的用户将自动获得此专属分组',
        platformLabel: '平台限制',
