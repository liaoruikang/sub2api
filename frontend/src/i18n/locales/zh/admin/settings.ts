...
modelPlaza: {
        ...
        imagePlayground: {
          title: '在线生图',
          description: '控制用户端在线生图页面入口。默认开启。',
          enabled: '启用在线生图',
          enabledHint: '关闭后用户端侧边栏入口隐藏，直接访问页面会被拦截。',
        },
        videoJobs: {
          title: '视频任务',
          description: '控制用户端视频任务页面入口。默认开启。',
          enabled: '启用视频任务',
          enabledHint: '关闭后用户端侧边栏入口隐藏，直接访问页面会被拦截。',
        },
        riskControl: {
        ...
        affiliate: {
          ...
          withdrawalEnabled: '启用返利提现',
          withdrawalEnabledHint: '开启后用户可以申请提现到支付宝；关闭不影响历史申请的处理。',
          withdrawalMinAmount: '最低可提现金额',
          withdrawalMinAmountHint: '用户单次申请金额不得低于此金额。',
          withdrawalFeeRate: '提现手续费',
          withdrawalFeeRateHint: '按申请金额百分比计算。申请 $100、手续费 1%，冻结 $100，实际转账 $99。',
          rebateRate: '全局返利比例',
