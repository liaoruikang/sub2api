export default {
  ...
  imagePlayground: {
    eyebrow: 'Online Image Generation',
    title: 'Image Playground',
    description: 'Generate and edit images with your own image-capable API keys. Results are saved locally in this browser.',
    loading: 'Loading image generation options...',
    ready: 'Choose a key, describe the image, and generate.',
    emptyStateTitle: 'No image-capable keys available',
    emptyStateDescription: 'Create an API key that can access image generation models before using the image playground.',
    generatorTitle: 'Generation settings',
    generatorDescription: 'Select a key, choose or type a model, then tune image output parameters.',
    apiKeyLabel: 'API Key',
    ...
    referenceDropTitle: 'Drop reference images here, or choose files',
    referenceBrowseAction: 'Choose images',
    referenceHint: 'Optional. Upload images to use edit mode. Each file must be 20MB or smaller.',
    referenceEditHint: 'Reference images are selected, so the request will use image edit mode.',
    referenceListLabel: 'Selected reference images',
    fileTooLarge: 'Too large',
    removeReferenceLabel: 'Remove reference image',
    removeReferenceAction: 'Remove',
    sizeLabel: 'Size',
    sizePickerTitle: 'Set image size',
    sizePickerCurrent: 'Current',
    sizePickerAutoTab: 'Auto',
    sizePickerRatioTab: 'By ratio',
    sizePickerCustomTab: 'Custom width/height',
    sizePickerAutoTitle: 'Auto size',
    sizePickerAutoDescription: 'Do not send a concrete resolution. Let the model decide the generated image size.',
    sizePickerResolutionLabel: 'Base resolution',
    sizePickerRatioLabel: 'Image ratio',
    sizePickerCustomRatioAction: 'Custom ratio',
    sizePickerCustomInputLabel: 'Enter exact pixel values',
    sizePickerWidthLabel: 'Width',
    sizePickerHeightLabel: 'Height',
    sizePickerLimitHint: 'Because of model limits, the final output may be normalized to a valid size: width and height should be multiples of 16, max side 3840px, aspect ratio no more than 3:1, and total pixels within 655360-8294400.',
    sizePickerWillUse: 'Will use',
    sizePickerCancel: 'Cancel',
    sizePickerConfirm: 'Confirm',
    qualityLabel: 'Quality',
    outputFormatLabel: 'Format',
    compressionLabel: 'Compression',
    compressionPlaceholder: '0-100',
    compressionInvalid: 'Compression must be an integer from 0 to 100.',
    moderationLabel: 'Moderation',
    countLabel: 'Quantity',
    countInvalid: 'Quantity must be a positive integer.',
    streamLabel: 'Stream response',
    streamHint: 'Use streaming for long OpenAI image generations to reduce Cloudflare timeout risk.',
    streamUnsupportedHint: 'Streaming is only available for OpenAI gpt-image generation without reference images.',
    submitHint: 'Full API keys are never exposed in the browser; only the selected key ID is sent.',
    generatingButton: 'Generating...',
    generateButton: 'Generate image',
    resultsTitle: 'Latest result',
    resultsDescription: 'Generated images and price for the most recent request.',
    resultsEmpty: 'Generated images will appear here.',
    generatedImageAlt: 'Generated image',
    previewImageAction: 'Preview image',
    downloadImageAction: 'Download',
    imagePreviewTitle: 'Image preview',
    closePreviewAction: 'Close preview',
    tipsTitle: 'Tips',
    tipPrompt: 'Use a concrete subject, scene, style, lighting, and composition.',
    tipReference: 'Upload reference images when you want edits or style transfer.',
    tipReuse: 'Reuse a history record to quickly regenerate with similar settings.',
    historyTitle: 'Local history',
    historyDescription: 'Generated images are stored locally in this browser with IndexedDB.',
    clearHistoryButton: 'Clear history',
    historyEmpty: 'No generated images saved yet.',
    reuseParamsButton: 'Reuse settings',
    deleteHistoryButton: 'Delete',
    loadOptionsFailed: 'Failed to load image generation options.',
    loadHistoryFailed: 'Failed to load local image history.',
    referenceTooLargeError: 'One or more reference images exceed 20MB. Remove oversized files before generating.',
    referenceAddedStatus: 'Reference image added.',
    generatingStatus: 'Generating image, please wait...',
    streamingStatus: 'Streaming image generation. Keep this page open...',
    streamingProgressStatus: 'Receiving streamed image updates...',
    generationProgressLabel: 'Generation progress',
    generationProgressIndeterminate: 'Generating',
    generationProgressPercent: '{percent}%',
    generationProgressImages: 'Received {count}/{total} images',
    previewZoomControlsLabel: 'Preview zoom controls',
    previewZoomInAction: 'Zoom in',
    previewZoomOutAction: 'Zoom out',
    previewZoomResetAction: 'Reset',
    previewPanHint: 'Drag to move the image.',
    generateSuccessStatus: 'Image generated successfully.',
    generateEmptyStatus: 'The request completed but returned no images.',
    generateFailed: 'Image generation failed. Please check the selected key, model, and parameters.',
    reuseParamsStatus: 'History settings have been applied.',
    historyDeletedStatus: 'History record deleted.',
    historyDeleteFailed: 'Failed to delete the history record.',
    historyClearedStatus: 'History cleared.',
  ...
  admin: {
    ...
    groups: {
      ...
      columns: {
        ...
        limitedTimeRpmOverrideHint: 'Per-user RPM cap in this group while the limited-time multiplier window is active; 0 = unlimited for the window',
        rateDefault: 'default',
        rpmDefault: 'default',
        type: 'Type',
        accounts: 'Accounts',
      ...
      form: {
        ...
        userConcurrencyLimit: 'Per-user Concurrency',
        userConcurrencyLimitPlaceholder: '0 = unlimited',
        userConcurrencyLimitHint: 'Max simultaneous requests each user can run in this group; 0 = unlimited.'
      },
      ...
      limitedTimeMultiplier: {
        title: 'Limited-time multiplier',
        hint: 'Only applies to standard balance groups. During the active window, billing uses the limited-time multiplier only when it is lower than the current billing rate; it will not raise a lower user-specific rate.',
        startTime: 'Start time',
        startTimeHint: 'Choose a daily, weekly, or monthly start time. The cron expression is generated automatically.',
        hourOption: '{hour} h',
        minuteOption: '{minute} m',
        value: 'Rate multiplier',
        duration: 'Duration',
        durationUnit: 'Duration unit',
        limitedTimeRpmLimit: 'Limited-time RPM',
        limitedTimeRpmLimitPlaceholder: '0 = no dedicated limited-time cap',
        limitedTimeRpmLimitHint: 'Max requests per minute per user in this group while the limited-time multiplier is active. 0 falls back to normal RPM rules. User-specific limited-time RPM overrides take precedence.',
        limitedTimeUserConcurrencyLimit: 'Limited-time per-user concurrency',
        limitedTimeUserConcurrencyLimitPlaceholder: '0 = no dedicated limited-time cap',
        limitedTimeUserConcurrencyLimitHint: 'Max simultaneous requests each user can run in this group while the limited-time multiplier is active. 0 falls back to the normal per-user concurrency rule.',
        tableBadge: 'Limited {value}x · {schedule} {timeRange} {active}',
        effectiveTooltip: 'Limited-time multiplier is active. {limited}x is lower than the current user rate {normal}x, so billing uses {limited}x.',
        effectiveTooltipDefault: 'Limited-time multiplier is active, so billing uses {limited}x.',
        frequency: {
          daily: 'Daily',
          weekly: 'Weekly',
          monthly: 'Monthly'
      ...
      limitedTimeRpmOverrides: 'Limited RPM',
      limitedTimeRpmOverridesTitle: 'Limited-Time RPM Overrides',
      addUserLimitedTimeRpm: 'Add Limited-Time RPM Override',
      ...
      limitedTimeRpmHint: 'Only applies while this group’s limited-time multiplier window is active. 0 means unlimited for this user/group window, while the user global RPM still applies.',
      groupRpmDefault: 'Group default RPM',
      limitedTimeGroupRpmDefault: 'Limited-time default RPM',
    ...
    accounts: {
      ...
      bulkHighestSchedulingEnabled: 'Successfully enabled highest scheduling for {count} account(s)',
      bulkHighestSchedulingDisabled: 'Successfully disabled highest scheduling for {count} account(s)',
      bulkHighestSchedulingPartial: 'Highest scheduling updated partially: {success} succeeded, {failed} failed',
      bulkHighestSchedulingResultUnknown: 'Bulk highest scheduling result incomplete. Please retry or refresh.',
      highestSchedulingEnabled: 'Highest scheduling mode enabled',
      highestSchedulingDisabled: 'Highest scheduling mode disabled',
      failedToToggleHighestScheduling: 'Failed to toggle highest scheduling mode',
      enableHighestSchedulingAction: 'Enable highest scheduling mode',
      disableHighestSchedulingAction: 'Disable highest scheduling mode',
      highestSchedulingOn: 'On',
      highestSchedulingOff: 'Off',
      bulkActions: {
        ...
        enableHighestScheduling: 'Enable Highest Scheduling',
        disableHighestScheduling: 'Disable Highest Scheduling',
      ...
      bulkEdit: {
        ...
        highestSchedulingHint: 'Bulk edit can enable or disable highest scheduling for all selected accounts and optionally set the recovery time after errors.'
      },
      ...
      highestSchedulingMode: 'Highest Scheduling Mode',
      highestSchedulingModeHint:
        'Prefer this account before normal accounts when it passes the existing scheduling filters. Full, blocked, or errored accounts still fall back normally.',
      highestSchedulingRecoveryMinutes: 'Recovery Time After Error (minutes)',
      highestSchedulingRecoveryMinutesHint: '0 or empty means highest scheduling stays paused after an account error until manually resumed.',
      highestSchedulingSuppressed: 'Highest scheduling is currently paused because this account hit an error.',
      highestSchedulingSuppressedUntil: 'It will resume after {time} once the account itself is schedulable again.',
      highestSchedulingSuppressedManual: 'Manual resume is required before this account receives highest scheduling preference again.',
      highestSchedulingManualResume: 'Resume highest scheduling now',
      highestSchedulingSuppressedReason: 'Reason: {reason}',
    ...
    settings: {
      ...
      site: {
        ...
        contactInfoPlaceholder: 'e.g., <a href="https://t.me/example" target="_blank" rel="noopener noreferrer">Telegram Support</a>',
        contactInfoHint: 'Customer support contact info. HTML is supported and displayed in the top-right dropdown, redeem page, profile, etc.',
  ...
  payment: {
    ...
    errors: {
      ...
      PLAN_PURCHASE_LIMIT_REACHED: 'This plan has reached your purchase limit.',
      PLAN_PURCHASE_LIMIT_INVALID: 'Purchase limit must be 0 or greater.',
      PLAN_IP_PURCHASE_LIMIT_REACHED: 'Not eligible.',
      PLAN_IP_PURCHASE_LIMIT_INVALID: 'IP purchase limit must be 0 or greater.',
      PLAN_STOCK_INVALID: 'Stock must be 0 or greater.',
      PLAN_OUT_OF_STOCK: 'This plan is out of stock.',
      PLAN_NEW_USER_ONLY: 'This plan is only available to new users who registered after it was listed.',
      PLAN_FIRST_PURCHASE_DISCOUNT_INVALID: 'First purchase discount price is invalid.',
    ...
    firstOrderSpecial: 'First-order special',
    planFeatures: 'Features',
    planCount: 'plans',
    planCard: {
      rate: 'Rate',
      purchaseLimit: 'Per-user Limit',
      stock: 'Stock',
      ...
      unlimited: 'Unlimited',
      soldOut: 'Sold out',
      stockEnough: 'In stock',
      stockLow: 'Low stock',
      stockLowWithCount: 'Low stock ({count})',
      newUserOnly: 'New users only',
      newUserOnlyHint: 'Only users registered after this plan was listed can buy it.',
      notEligible: 'Not eligible',
      ipLimitReached: 'Not eligible',
      offSaleCountdown: 'Off-sale Countdown',
      offSold: 'Off Sale',
      countdownDays: '{days}d {time}',
      countdownTime: '{time}',
    ...
    admin: {
      ...
      price: 'Price',
      purchaseLimitCount: 'Per-user Purchase Limit',
      purchaseLimitCountHint: '0 means unlimited.',
      ipPurchaseLimitCount: 'Per-IP Purchase Limit',
      ipPurchaseLimitCountHint: '0 means unlimited.',
      stockCount: 'Stock',
      soldOut: 'Sold out',
      newUserOnly: 'New-user Only',
      newUserOnlyHint: 'When enabled, only users registered no earlier than the listed time can buy this plan.',
      listedAt: 'Listed At',
      listedAtHint: 'Used for new-user eligibility. When relisting and left empty, the server sets it to the current time.',
      firstPurchaseDiscountEnabled: 'First-purchase Discount',
      firstPurchaseDiscountPrice: 'First-purchase Price',
      firstPurchaseDiscountPriceInvalid: 'First-purchase discount price must be greater than 0 and less than the base price.',
      ...
      forSale: 'For Sale',
      offSaleAt: 'Off-sale Time',
      offSaleAtHint: 'The plan will be hidden automatically after this time. Leave empty to keep it on sale.',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',
      groupId: 'Group ID',
